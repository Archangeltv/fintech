...
const page = () => {
  ...
  //   try {
  //     setNotLoading(false);
  //     await signUp(name, agent, email, password);
  ...
  // useEffect(() => {
  //   if (user && !isRedirectedRef.current) {
  ...
  //           <h2
  //             className="text-center text-2xl text-myGreen font-display font-semibold lg:text-center xl:text-3xl
  //               xl:text-bold"
  //           >
  ...
  //                 </div>
  //                 <input
  //                   className="w-full text-lg py-2 border-b bg-transparent border-myGreen focus:outline-none focus:border-myGreen"
  //                   type="text"
  //                   required
  ...
  //                     error ? "border-red-600" : "border-myGreen"
  ...
  //                     name="show"
  //                     id="show"
  //                     className="cursor-pointer checked:bg-myGreen"
  //                     onChange={(e) => {
  ...
  //             <div className="mt-12 pb-20 text-sm font-display font-semibold text-gray-700 text-center">
  ...
  return <div className="text-text">Hello</div>;
};
